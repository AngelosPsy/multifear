...
Another important column is the cut_off column that shows what data have been used. Here we have:
...
1) full_data: full data set

2) last_2_trials: last two trials

3) last_4_trials: last four trials

5) last_4_trials: last five trials
...
And here we have the specification curves for the performed frequentists t-tests.
